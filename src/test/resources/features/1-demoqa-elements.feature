...
@run
  Scenario: Links
    ...
    Then  "Link response" should contain "201"
    And   "Link response" should contain "Created"
    When  I click "No Content link"
    Then  "Link response" should contain "204"
    And   "Link response" should contain "No Content"
    When  I click "Moved link"
    Then  "Link response" should contain "301 and status text Moved Permanently"
    #Making 301 test match the others makes it fail and I'm not sure why.
    #And   "Link response" should contain "Moved Permanently"
    When  I click "Bad Request link"
    Then  "Link response" should contain "400"
    And   "Link response" should contain "Bad Request"
    When  I click "Unauthorized link"
    Then  "Link response" should contain "401"
    And   "Link response" should contain "Unauthorized"
    When  I click "Forbidden link"
    Then  "Link response" should contain "403"
    And   "Link response" should contain "Forbidden"
    When  I click "Not Found link"
    Then  "Link response" should contain "404"
    And   "Link response" should contain "Not Found"
